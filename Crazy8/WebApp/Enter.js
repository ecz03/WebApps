...
const url = "http://107.23.229.16:8000/players";
const urlUserCount = "http://107.23.229.16:8000/playerCount";
    ...
    async fetchPlayers(){
       ...
       console.log(GETdata);
        ...
        if(response.data !== "JuegoInexistente"){
            ...
            this.setState({
                totalPlayers: parseInt(data.total_jugadores),
                connected: parseInt(data.conectados),
            }, ()=>{
                console.log("Total, COnectados");
                console.log(this.state.totalPlayers);
                console.log(this.state.connected);
                console.log("TEST")
                console.log(this.state.totalPlayers === this.state.connected)
                   ...
                   <div className="d-flex p-3 mt-2 flex-row justify-content-center ">
                           ...
                           <div className="d-flex justify-content-center col-md-3 ml-3 span2 align-self-end" >
                                <div className="d-flex" >
                                   ...
                                   <Octicon icon={getIconByName('sign-out')} size='large' className="align-self-center"/>
                                   </button>
                                </div>
                           </div>
